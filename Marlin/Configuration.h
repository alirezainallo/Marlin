...
#define STRING_CONFIG_H_AUTHOR "(AAVAN, Alireza Inallo)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Aavan 3D Printer"
...
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT { 80, 80, 1600, 268.57 }
#endif
